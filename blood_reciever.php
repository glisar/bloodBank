...
<html>
    ...
    <div class="container_signup">
      <br><br>
      <div class="signup123"><hr>Blood Reciever Registration<hr></div>
      
      
        <form action="signup.php" method="post">
            <div class="signup-form123" >
              <input type="text" placeholder="Enter your name" name="name" class="input_signup" required><br />
              ...
              <input type="submit" class="btn_signup" name="submit" value="Submit"/><br>
